...
function writeBundleReadme(bundleDir, options) {
  const lines = [
    ...
    '',
    'The Artifactory uploader is maintained separately in the airgapped environment.',
    'Use packages.json, packages.jsonl, or artifactory-upload-manifest.tsv as the uploader input.',
    '',
    'Files:',
