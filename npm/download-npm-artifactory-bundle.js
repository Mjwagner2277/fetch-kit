...
function writeBundleReadme(bundleDir, options) {
  const lines = [
    ...
    '',
    'The Artifactory uploader script is maintained separately in the airgapped environment.',
    'Use upload-npm-artifactory-bundle.js with this transfer tar, or use packages.json,',
